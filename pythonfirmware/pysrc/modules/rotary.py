...
_transition_table_halfstep = [

    # |------------- NEXT STATE -------------|            |CURRENT STATE|
    # CLK/DT    CLK/DT     CLK/DT    CLK/DT
    #   00        01         10        11
    [_R_START, _R_CCW_1,  _R_CW_1,  _R_START],            # _R_START
    [_R_CW_2 | _DIR_CW,  _R_START,  _R_CW_1,  _R_START],            # _R_CW_1
    [_R_CW_2,  _R_CW_3,   _R_CW_1,  _R_START],            # _R_CW_2
    [_R_CW_2,  _R_CW_3,   _R_START, _R_START | _DIR_CW],  # _R_CW_3
    [_R_CCW_2 | _DIR_CCW, _R_CCW_1,  _R_START, _R_START],            # _R_CCW_1
...
class Rotary(object):
    ...
    def __init__(self, min_val, max_val, reverse, range_mode, half_step=False):
    ...
    def set(self, value=None, min_val=None, max_val=None, reverse=None, range_mode=None, half_step=None):
    ...
    def _process_rotary_pins(self, pin):
        ...
        if self.half_step:
            self._state = _transition_table_halfstep[self._state & _STATE_MASK][clk_dt_pins]
        else:
